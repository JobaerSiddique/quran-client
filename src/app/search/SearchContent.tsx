...
//       {/* Header - Removed motion.div, using regular div */}
//       <div className="mb-8">
//         <button
//           onClick={() => router.back()}
...
//             {/* Filters Panel - Using CSS transition instead of Framer Motion */}
//             <div
...
// Dynamic import with ssr: false (Most important fix)
const AyahCard = dynamic(() => import("@/components/surah/AyahCard"), {
  ssr: false,
});
            ...
            <div className="flex justify-center gap-2 mt-8">
              ...
              <div className="join">
                {Array.from({ length: Math.min(5, meta.totalPage) }, (_, i) => {
                  let pageNum = i + 1;
                  if (meta.totalPage > 5) {
                    if (currentPage > 3 && currentPage < meta.totalPage - 2) {
                      pageNum = currentPage - 2 + i;
                    } else if (currentPage >= meta.totalPage - 2) {
                      pageNum = meta.totalPage - 4 + i;
                    }
